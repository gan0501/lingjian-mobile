...
type Props = RootStackScreenProps<'ManufacturerClaim'>;

const ManufacturerClaimScreen: FC<Props> = ({ navigation, route }) => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      await enterpriseService.claimManufacturer({
  ...
  }, [manufacturerId, licenseUrl, licenseLocalUri, contactName, contactPhone, contactPosition, navigation]);

  return (
    <View style={styles.container}>
      <Header title="认领厂家" showBack onBack={() => navigation.goBack()} />
      ...
      >
        ...
        >
          <View style={styles.infoCard}>
            <Text style={styles.infoLabel}>认领厂家</Text>
          ...
          <View style={styles.tipsCard}>
            ...
            <Text style={styles.tipsText}>3. 审核通过后，您将成为该厂家的管理员</Text>
...
export default ManufacturerClaimScreen;
